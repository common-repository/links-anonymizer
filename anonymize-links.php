...
Plugin URI: https://www.anonymizer.info/
...
Version: 1.1
Author: ANONYMIZER.INFO
Author URI: https://www.anonymizer.info/
*/
...
final class anonymize_links {
	...
	public function anonymize_links_init(){
		wp_register_script('anonymize_links-anonymize_links', WP_PLUGIN_URL . '/links-anonymizer/js/anonymize.js');
	}
	...
	public function anonymize_links_menu(){
		add_options_page('Link Anonymizer Options', 'Link Anonymizer', 'administrator', 'anonymize_links-options', array($this,'anonymize_links_options_page'));
	}	
	...
	public function anonymize_links_options_page(){
		...
		echo '<div class="wrap">';
		echo '<h2>'. __('Link Anonymizer Options') .'</h2>';
		?>			
		...
		<table class="form-table">			
			<tr valign="top">				
				<td>
                    ...
                    <p class="description">Note: Please Don't use space after commas</p>		
				</td>
			</tr>
		</table>
		<p class="submit">
